package com.example.cardgame.ui.levelsix
...
class LevelSixFragment : Fragment(), KodeinAware, CardAdapter.OnItemClickListener, ErrorListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_level_six, container, false)
        ...
        viewmodel.getLevelById(6).observe(this, Observer {
            if (it == null) {
                viewmodel.insertSaveUpdateLevel(Level(6, 0, finished = false))
        ...
        viewmodel.getImages(7).observe(this, Observer {
        ...
        viewmodel.getListOfPhoto().observe(this, Observer {
            if (it.size == 14 && score.text != "0") {
                var s: Int = score.text.toString().toInt()
                viewmodel.insertSaveUpdateLevel(Level(6, s, finished = true))
            }
        })
        return view
    }
    ...
    override fun onItemClicked(photo: Photo) {
        viewmodel.imageClicked(photo, 6)
