package com.example.cardgame.ui.levelfive
...
class LevelfiveFragment : Fragment(), KodeinAware, CardAdapter.OnItemClickListener, ErrorListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_levelfive, container, false)
        ...
        viewmodel.getLevelById(5).observe(this, Observer {
            if (it == null) {
                viewmodel.insertSaveUpdateLevel(Level(5, 0, finished = false))
        ...
        viewmodel.getImages(6).observe(this, Observer {
        ...
        viewmodel.getListOfPhoto().observe(this, Observer {
            if (it.size == 12 && score.text != "0") {
                var s: Int = score.text.toString().toInt()
                viewmodel.insertSaveUpdateLevel(Level(5, s, finished = true))
            }
        })
        return view
    }
    ...
    override fun onItemClicked(photo: Photo) {
        viewmodel.imageClicked(photo, 5)
